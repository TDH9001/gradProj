...
//   SendMessageButton(required GlobalKey<FormState> GK, 
//       {super.key,
...
//       child: IconButton(
//         icon: Icon(
//             ChatCubit.get(context).txt.text.isEmpty
//                 ? (widget.isRecording ? Icons.stop : Icons.mic)
//                 : Icons.send,
//             color: LightTheme.primary),
//         onPressed: () async {
//           if (ChatCubit.get(context).txt.text.isEmpty) {
...
//                     senderID:
//                         HiveUserContactCashingService.getUserContactData().id,
//                     messageContent: ChatCubit.get(context).txt.text.trim(),
//                     timestamp: Timestamp.now(),
//                     type: "text",
//                     senderName:
//                         "${HiveUserContactCashingService.getUserContactData().firstName} ${HiveUserContactCashingService.getUserContactData().lastName}"));
